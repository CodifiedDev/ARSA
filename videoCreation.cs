...
namespace ARSA
{
    internal class videoCreation
    {
        ...
        { 
            ...
            FFMpegCore.FFMpeg.SubVideo(Directory.GetCurrentDirectory() + "/tmp/finalsub.mp4", Directory.GetCurrentDirectory() + "/tmp/finalshort.mp4", TimeSpan.FromSeconds(0), TimeSpan.FromSeconds(60));
        }
    }
}
