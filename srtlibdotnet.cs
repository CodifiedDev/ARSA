...
//This is a libary from https://github.com/iivmok/srtlib.net/blob/master/srtlib.net.cs, but it literaly does not have any pre-built binaries, so here is the base code, and is in no way shape or form mine.
{
    /// <summary>
